...
long __stdcall hkEndScene(IDirect3DDevice9 * Device)
{
	...
	DX9::Render.DrawFilledRectWithBorder(100.0f, 100.0f, 50.0f, 50.0f, 2.0f, D3DCOLOR_ARGB(255, 255, 0, 0), D3DCOLOR_ARGB(255, 255, 0, 0));

	//ESP.Render();

	FLOAT ScreenX = RefDef->GetScreenWidth() / 2;
	FLOAT ScreenY = RefDef->GetScreenHeight() / 2;
...
void D3D9_Hook::Hook()
{
	if (GetModuleHandle("d3d9.dll"))
	{
		...
		while (pDevice == NULL)
		{
			...
			pDevice = *(IDirect3DDevice9**)0x6664C60;//Creating Direct3D device...\n
		}
